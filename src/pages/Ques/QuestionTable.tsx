...
// Import the Loader component - assuming it's in the components directory
import Loader from '../../components/Loader';

interface QuestionTableProps {
  questions: Question[];
  isLoading?: boolean; // Add an optional isLoading prop
}
...
const QuestionTable: React.FC<QuestionTableProps> = ({ 
  ...
  // Track loading state internally if not provided by props
  const [loading, setLoading] = useState(isLoading);

  // Simulate loading complete when questions change or component mounts
  useEffect(() => {
